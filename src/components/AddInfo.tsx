    ...
    <>
      <div className="w-full flex justify-center relative">
        <Input
          input={input}
          setInput={setInput}
          className="w-3/4 absolute top-0  p-2 mb-10 h-12  tracking-wide border-b-[1px] focus:h-16 transition-all  text-xl border-gray-400 outline-none bg-transparent"
          ...
          {data && (
            <>
              ...
              >
                ...
                <AddInfoTableEl title="Time Zone" value={`${data.timezone}`} />
              </AddInfoTable>
              ...
              <AddInfoTable overflow={true} icon={<IoWarning />} title="Alerts">
